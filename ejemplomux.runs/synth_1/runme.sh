...
HD_PWD='C:/Users/juanl_00e1ytj/OneDrive/Escritorio/Sistemas Electronicos/ejemplomux/ejemplomux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux21_structural.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux21_structural.tcl
